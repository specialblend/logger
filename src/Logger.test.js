            ...
            describe('logger method', () => {
                describe('fatal', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('calls expected stderr with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.FATAL, $myFancyLogger.build_record(LogLevel.FATAL, $data));
                ...
                describe('error', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('writes to expected stderr with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.ERROR, $myFancyLogger.build_record(LogLevel.ERROR, $data));
                            expect(console.error).toHaveBeenCalledWith($expectedMessage);
                        });
                    });
                });
                describe('warn', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('writes to expected stdout with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.WARN, $myFancyLogger.build_record(LogLevel.WARN, $data));
                ...
                describe('info', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('writes to expected stdout with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.INFO, $myFancyLogger.build_record(LogLevel.INFO, $data));
                            expect(console.log).toHaveBeenCalledWith($expectedMessage);
                        });
                    });
                });
                describe('debug', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('writes to expected stdout with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.DEBUG, $myFancyLogger.build_record(LogLevel.DEBUG, $data));
                            expect(console.log).toHaveBeenCalledWith($expectedMessage);
                        });
                    });
                });
                describe('trace', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('writes to expected stdout with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.TRACE, $myFancyLogger.build_record(LogLevel.TRACE, $data));
                            expect(console.log).toHaveBeenCalledWith($expectedMessage);
                        });
                    });
                });
                describe('silly', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('writes to expected stdout with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.SILLY, $myFancyLogger.build_record(LogLevel.SILLY, $data));
                            expect(console.log).toHaveBeenCalledWith($expectedMessage);
                        });
                    });
                });
            ...
            describe('logger method', () => {
                ...
                describe('info', () => {
                    ...
                    describe('when called', () => {
                        ...
                        test('does NOT write to expected stdout with expected payload', () => {
                            const $expectedMessage = $myFancyLogger.serialize(LogLevel.INFO, $myFancyLogger.build_record(LogLevel.TRACE, $data));
                            expect(console.log).not.toHaveBeenCalledWith($expectedMessage);
                        });
                    });
                });
            ...
            describe('without err', () => {
                describe('with no log level', () => {
                    ...
                    test('calls console.error with expected payload', () => {
                        ...
                        const $expectedMessagePayload = $logger.build_record(LogLevel.ERROR, $expectedData);
                ...
                describe('when log level is', () => {
                    describe.each($LOG_LEVELS)('%s', (_$, $level, $output) => {
                        ...
                        test('calls expected output with expected payload', () => {
                            ...
                            const $expectedMessagePayload = $logger.build_record($level, $expectedData);
